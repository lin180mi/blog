...
| Windows (使用 Cargo) | `cargo install yazi` |
...
*说明：<kbd>c</kbd> ⇒ <kbd>d</kbd> 表示先按下 <kbd>c</kbd> 键，然后按下 <kbd>d</kbd> 键。*
...
*说明：<kbd>,</kbd> ⇒ <kbd>a</kbd> 表示先按下 <kbd>,</kbd> 键，再按下 <kbd>a</kbd> 键。*
...
| <kbd>1</kbd>...<kbd>9</kbd> | 切换到第 N 个标签页 |
| <kbd>[</kbd> | 切换到上一个标签页 |
| <kbd>]</kbd> | 切换到下一个标签页 |
